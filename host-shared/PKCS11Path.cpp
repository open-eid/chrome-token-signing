...
PKCS11Path::Params PKCS11Path::getPkcs11ModulePath() {
    ...
    static const std::map<std::string, Params> m = {
...
#else
        {"3BFE1800008031FE45803180664090A4162A00830F9000EF", {estPath, "PIN1", "PIN2"}}, //ESTEID_V3.5_WARM_ATR
        {"3BFA1800008031FE45FE654944202F20504B4903", {estPath, "PIN1", "PIN2"}}, //ESTEID_V3.5_COLD_ATR
        {"3BDB960080B1FE451F830012233F536549440F9000F1", {estPath, "PIN1", "PIN2"}}, // ESTEID_IDEMIA_2018
        ...
        {"3B7B940000806212515646696E454944", {access(finPath.c_str(), F_OK) == 0 ? finPath : openscPath, "PIN1", "PIN2"}},
